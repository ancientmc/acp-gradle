...
public class AcpPlugin implements Plugin<Project> {
    ...
    public void apply(final @NotNull Project project) {
        ...
        // Sets Minecraft to run and compile against Java 8. This avoids any issues that come with running Minecraft on newer JDKs, such as wonky window sizes.
        ...
        cleanup.configure(task -> {
            ...
            task.setDescription("Cleans directories of files generated by decompiling and mod building.");
        });
